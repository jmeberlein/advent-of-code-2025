...
HOW IZ I checkin_sublen YR number AN YR sublen
    DIFFRINT sublen AN BIGGR OF sublen AN 2, O RLY?
        YA RLY, FOUND YR FAIL
    OIC

    I HAS A len ITZ I IZ STRING'Z LEN YR number MKAY
    DIFFRINT MOD OF len AN sublen AN 0, O RLY?
        YA RLY, FOUND YR FAIL
    OIC
    len R QUOSHUNT OF len AN sublen
    I HAS A other
    IM IN YR loop UPPIN YR idx TIL BOTH SAEM idx AN len
        IM IN YR inner_loop UPPIN YR i TIL BOTH SAEM i AN sublen
            other R SUM OF idx AN PRODUKT OF i AN len
            DIFFRINT I IZ STRING'Z AT YR number AN YR idx MKAY AN I IZ STRING'Z AT YR number AN YR other MKAY, O RLY?
                YA RLY, FOUND YR FAIL
            OIC
